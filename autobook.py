...
class BookingCore:
    ...
    def init_booking(self):  # init booking core
        ...
        self.procedure_monitor()

    def procedure_login(self):  # login
    ...
    def procedure_monitoring(self):
        self.procedure_locate_date()
    ...
    def procedure_select_sport(self): # Start to select sport
        current_url = self.driver.current_url
    ...
    def procedure_locate_date(self):
        while not self.check_date():
            self.check_date()

...
class BookingCore:
    ...
    def _back_up_timepoint(self):
        """
        This function will be ran if there is no court avialbles for certain period of time, for exmaple, all the courts are booked for certain activitiies during these time. W
        w

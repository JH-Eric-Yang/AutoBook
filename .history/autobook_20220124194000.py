...
class BookingCore:
    ...
    def _procedure_court_monit(self):
        ...
        available_timeslot = self.driver.find_elements(By.CLASS_NAME, "itemavailable") # check whether the time slot has been released 
    ...
    def _court_booking(self):
        ...
        if target_index:
            valid_time_slot[index].click()
            print("Preferred court avialable")
        else:  # No preferred court going to next
            print("Preferred court is not availalbe")
